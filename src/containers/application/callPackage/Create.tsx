...
import {createCallPackage} from "ajaxRequests/callPackages";
...
class Create extends React.Component<ICreateProps, ICreateState> {
    ...
    componentWillMount(): void {
        document.title = PAGE_NAME["/call-package/create"];
    }
    ...
    handleAttributesChange = ({currentTarget: {value, name}}: React.ChangeEvent<HTMLInputElement>): void => {
        ...
        newState.validation[name].error = isNumeric ? "" : "This field is required or its value has to be number";
        this.setState(newState);
    };
    ...
    handlePricingChange = ({currentTarget: {value, name}}: React.ChangeEvent<HTMLInputElement>): void => {
        ...
        newState.validation[name].error = parsedValue >= 0 ? "" : "This field is required or its value has to be number";
        this.setState(newState);
    };
    ...
    handelSubmit = (e: React.FormEvent<HTMLFormElement>): void => {
        ...
        createCallPackage(callPackageModel).then(response => {
            const newState: any = {...this.state};
            if (!response.data.err) {
                newState.callPackageModel = {
                    cost: "",
                    countryCodes: null,
                    days: "",
                    minutes: "",
                ...
                showNotification("error", {
                    ...
                    description: "Call package is not created",
                    id: toastId
                });
            }
            ...
            if (this.componentState) {
                showNotification("success", {
                    title: "Success!",
                    description: "Call package is successfully created",
                    id: toastId
                });
                this.setState(newState);
            }
    ...
    render(): JSX.Element {
        const {processing, callPackageModel, _country, validation} = this.state;
        const {countries} = this.props;
        const disabled: boolean = Object.keys(callPackageModel).every(item => {
            return callPackageModel[item] !== "";
        });
            ...
            <div className="container-fluid no-padder">
                {/*<div className="row m-b-md">*/}
                    {/*<div className="col-lg-6 col-md-4 col-sm-4 col-xs-4">*/}
                        {/*<span className="text-xsl text-black">{PAGE_NAME["/call-package/create"]}</span>*/}
                    {/*</div>*/}
                {/*</div>*/}
                <div className="row">
                                    ...
                                    <div className="row">
                                        <div className="col-lg-12">
                                            <FormGroup validationState={validation.country.value}>
                                                <ControlLabel htmlFor="country_id">Country</ControlLabel>
                                                <Select
                                        ...
                                        <div className="col-lg-4">
                                            <FormGroup validationState={validation.minutes.value}>
                                                <ControlLabel htmlFor="minutes">Calling minutes</ControlLabel>
                                                <FormControl
                                                    type="number"
                                                    name="minutes"
                                                    id="minutes"
                                            ...
                                            <FormGroup>
                                                ...
                                                ><span className={callPackageModel.days === 0 ? "text-muted" : "font-bold"}>Unlimited minutes</span>
                                                </Checkbox>
                                            </FormGroup>
                                        </div>
                                        <div className="col-lg-4">
                                            <FormGroup validationState={validation.days.value}>
                                                <ControlLabel htmlFor="days">Active days</ControlLabel>
                                                <FormControl
                                                    type="number"
                                                    name="days"
                                                    id="days"
                                            ...
                                            <FormGroup>
                                                <Checkbox
                                                    ...
                                                    name="days"
                                                    onChange={this.handleUnlimitedChange}
                                                ><span className={callPackageModel.minutes === 0 ? "text-muted" : "font-bold"}>A package without expiration</span>
                                                </Checkbox>
                                            </FormGroup>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-4">
                                            ...
                                            <FormGroup validationState={validation.cost.value}>
                                                <ControlLabel htmlFor="cost">Package price in USD</ControlLabel>
                                                <FormControl
                                                    type="number"
                                                    name="cost"
                                                    id="cost"
                                            ...
                                            <div className="f-l m-l-md">
                                                <FormGroup>
                                                    <Checkbox
                                                        name="isTop"
                                                        onChange={this.handleCheckboxChange}
                                                    ><span className="font-bold">Is top</span>
                                                    </Checkbox>
                                                </FormGroup>
                                            </div>
