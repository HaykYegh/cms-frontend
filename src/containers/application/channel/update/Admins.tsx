...
import {getAdminsOfChannel, getAdminsCountOfChannel, setChannelAdministrator} from "ajaxRequests/channel";
...
class Admins extends React.Component<IAdminsProps, IAdminsState> {
    ...
    initRequests = (state: any, offset: number = 0): void => {
        ...
        const {limit} = state;
        getAdminsOfChannel(channelId, offset, limit).then(({data}: AxiosResponse) => {
            if (data.err) {
            ...
            if (this.componentState) {
                ...
                showNotification("error", {
                    ...
                    description: "Cannot get channel admins",
                    timer: 3000
                });
            }
        });

        getAdminsCountOfChannel(channelId).then(({data}: AxiosResponse) => {
            if (data.err) {
                throw new Error(JSON.stringify(data));
            }
            ...
            if (this.componentState) {
                ...
                showNotification("error", {
                    title: "You've got an error!",
                    description: "Cannot get channel admins count",
                    timer: 3000
                });
            }
        });
    ...
    handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        setChannelAdministrator(channelId,
            {
                email: admin.email,
                    ...
                    <div className="container-fluid">
                        <div className="row">
                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                <span className="text-lg m-b-md block">Administrators{channelName === "" ? "" : ` of ${channelName}`}</span>
                            </div>
                            <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6">
