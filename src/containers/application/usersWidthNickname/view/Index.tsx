...
import Devices from "containers/application/usersWidthNickname/view/Devices";
import User from "containers/application/usersWidthNickname/view/UserInformation";
import {ToastContainer} from "react-toastify";
import DIDNumber from "containers/application/usersWidthNickname/view/DIDNumber";
// import DIDNumber from "containers/application/usersWidthNickname/view/DIDNumber";
    ...
    render(): JSX.Element {
        ...
        return (
            <div>
                ...
                {user && !userProfile.readonly &&
                <UserAttempts
                  nick_email={user.nick_email}
                  email={user.email}
                  username={user.username}
                  isVerified={true}
                  isEmail={!!user.nick_email}
                />}
            </div>
        );
    }
