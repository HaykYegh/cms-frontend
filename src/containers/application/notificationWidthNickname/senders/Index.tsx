...
import {getSendersList, getSendersCount, createSender} from "ajaxRequests/notification";
import {getCurrentOffset, isNumeric, validateNumber} from "helpers/DataHelper";
import Update from "containers/application/notificationWidthNickname/senders/Update";
                ...
                {isLoading ? <Loading/>
                    ...
                    >
                        ...
                        {senders.map((sender, index) => {
                            ...
                            return (
                                <tr key={N} onClick={updateSender} className="cursor-pointer">
                                    <td>{N}</td>
