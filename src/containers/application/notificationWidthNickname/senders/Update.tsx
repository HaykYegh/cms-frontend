...
class Update extends React.Component<IUpdateProps, IUpdateState> {
    ...
    existsImage = (image: any): boolean => {
        return !!((image.blobUrl && image.blobUrl !== "") || (image.signedUrl));
    };
    ...
    render(): JSX.Element {
        ...
        const malog: any = (props) => {
            console.log("malog -> props -> ", props);
        };
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div className="container-fluid no-padder">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                {
                                                    this.existsImage(images) &&
                                                    <img
                                                        className="img-responsive contain m-b-md m-t-md"
                                                        src={this.getImageUrl(images)}
                                                        alt="Image"
                                        ...
                                        <form className="form-horizontal">
                                            ...
                                            <FormGroup>
                                                ...
                                                <div className="col-lg-offset-4 col-lg-8 col-md-offset-4 col-md-8 col-sm-8 col-sm-offset-4 col-xs-12">
                                                    {
                                                        this.existsImage(popup.images) &&
                                                        <img
                                                            className="img-responsive contain m-b-md m-t-md"
                                                            src={this.getImageUrl(popup.images)}
                                                            alt="Image"
                                                            style={{width: "100px", height: "100px"}}
                                                        />
                                                    }
